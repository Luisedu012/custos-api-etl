...
class PessoalAtivoCustos:
    """
    Inicializando PessoalAtivoCustos com os parâmetros necessários
    """
    ...
    def __init__(
        ...
        self.url = os.getenv("DEM_URL_PESSOAL_ATIVO")
    ...
    def fetch_data(self) -> None:
        """
        Busca pelos dados de custos de pessoal ativo entre os anos de 2015 á 2024.
