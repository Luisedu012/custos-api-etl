...
class TransferenciaCustos:
    """
    Inicializando TransferenciaCustos com os parâmetros necessários
    """
    ...
    def __init__(
        ...
        self.url = os.getenv("DEM_URL_TRANSFERENCIAS")
    ...
    def fetch_data(self) -> None:
        """
        Busca pelos dados de custos de transferências entre os anos de 2015 á 2024.
