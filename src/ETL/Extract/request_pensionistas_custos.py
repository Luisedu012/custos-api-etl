...
class PensionistasCustos:
    """
    Inicializando PensionistasCustos com os parâmetros necessários
    """
    ...
    def __init__(
        ...
        self.url = os.getenv("DEM_URL_PENSIONISTAS")
    ...
    def fetch_data(self) -> None:
        """
        Busca pelos dados de custos de pensionistas entre os anos de 2015 á 2024.
